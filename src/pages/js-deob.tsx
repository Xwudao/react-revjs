  ...
  return (
    <main className="js-deob-page">
      <div className="js-deob-shell">
        <section className="js-deob-hero">
          <div className="js-deob-panel js-deob-panel--hero">
            <span className="js-deob-kicker">
              <span
                className="i-mdi-layers-triple-outline text-base"
                aria-hidden="true"
              />
              RevJS Integrated Deob
            </span>
            <h1 className="js-deob-title">JS Deob 工作台</h1>
            <p className="js-deob-copy">
              deob 核心已经迁入 revjs 仓库，当前页面直接消费工作区源码；同一份实现也会通过
              tsdown 构建成 CLI，方便后续把规则、AST 变换和 AI 自动修补流程放在一处维护。
            </p>
            <div className="js-deob-actions">
              ...
              <button
                type="button"
                className="js-deob-button js-deob-button--ghost"
                onClick={copyOutput}
                disabled={!outputCode}
              >
              ...
              <Link to="/" className="js-deob-link">
          ...
          <aside className="js-deob-panel js-deob-status">
            <div>
              <span className="js-deob-status-badge" data-running={isRunning}>
                <span
                  className={
                    isRunning ? 'i-mdi-timer-sand' : 'i-mdi-check-circle-outline'
                  }
                  aria-hidden="true"
                />
            ...
            <div className="js-deob-meta">
              <div>
                <strong>Browser Entry</strong>
                <span>React 页面通过 worker 执行 deob，避免主线程卡顿。</span>
              </div>
              <div>
                <strong>CLI Entry</strong>
                <span>使用 `pnpm cli:js-deob -- input.js -o out` 调用内部包产物。</span>
              </div>
              <div>
                <strong>Last Run</strong>
                <span>{parseTime === null ? '尚未执行' : `${parseTime} ms`}</span>
              </div>
            </div>
          </aside>
        </section>
          ...
          <aside className="js-deob-sidebar">
            <div className="js-deob-panel js-deob-section">
              ...
              <p className="js-deob-section-copy">
                这里保留原工具里最关键的解密定位与变量名优化选项，足够在 Web
                端完成大多数调试。
              </p>
            ...
            <div className="js-deob-panel js-deob-section">
              <div className="js-deob-editor-head">
                <div>
                  ...
                  <p>粘贴原始混淆代码，worker 会使用迁移后的 deob 核心进行处理。</p>
                </div>
              </div>
              <textarea
                className="js-deob-textarea"
            ...
            <div className="js-deob-panel js-deob-section">
              <div className="js-deob-editor-head">
                <div>
                  ...
                  <p>这里会实时显示 deob 内部的定位、解密和错误日志。</p>
                </div>
                <button
                  type="button"
